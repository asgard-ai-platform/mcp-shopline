...
from tools.settings_tools import get_app_settings
...
if __name__ == "__main__":
    print("=" * 60)
    print("Settings Tools 端對端測試")
    print("=" * 60)
    print("注意：settings/app 端點已被 Shopline 標記為 deprecated")

    results = {}

    results["get_app_settings"] = run_test("get_app_settings", get_app_settings)
